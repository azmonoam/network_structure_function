...
folder_name = '10_features'
results_path = f"{base_path}/teach_archs/{task_name}"
results_path = f'{results_path}/{task_name}_teach_archs_requiered_features_genetic/{folder_name}'
results_folder ='results_on_xor_retina'
...
path = f"{results_path}/{time_str}_all_results_on_retina_xor_combined"
