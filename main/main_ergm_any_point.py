...
from ergm_model.ergm_to_any_point import ErgmAnyPoiny
...
if __name__ == '__main__':
    ...
    parser.add_argument('--job_num', default=10)
    ...
    parser.add_argument('--n_std', default=5)
    ...
    e = ErgmAnyPoiny(
        ...
        n_threads=n_threads,
        errors=errors,
        num_isolated_neurones_feature=0,
    )
