...
class FeedforwardNeuralNetModelOneLayer(NeuralNetModel):
    def __init__(
            self,
        ...
        super(FeedforwardNeuralNetModelOneLayer, self).__init__(weight_mask, bias_mask, dimensions, reinitiate,
                                                                 activate)
