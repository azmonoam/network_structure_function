...
class FeedforwardNeuralNetModelThreeLayers(NeuralNetModel):
    def __init__(
            self,
        ...
        super(FeedforwardNeuralNetModelThreeLayers, self).__init__(weight_mask, bias_mask, dimensions, reinitiate,
                                                                   activate)
