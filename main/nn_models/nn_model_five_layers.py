...
class FeedforwardNeuralNetModelFiveLayers(NeuralNetModel):
    def __init__(
            self,
        ...
        super(FeedforwardNeuralNetModelFiveLayers, self).__init__(weight_mask, bias_mask, dimensions, reinitiate,
                                                                  activate)
