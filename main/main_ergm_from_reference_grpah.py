...
if __name__ == '__main__':
    ...
    with open(
            f'{base_path}/teach_archs/{task}/{task}_teach_archs_requiered_features_ergm/{num_features}_features/ergm_results/{exp_name}_from_ref.pkl',
            'wb+') as fp:
        joblib.dump(res, fp)
