...
class Methods(MethodsBase):
    def __init__(
        ...
        self.output_neurons = list(range(self.num_neurons))[-self.dimensions[-1]:]
        self.max_possible_connections_ = sum(
    ...
    def max_possible_connections(
        ...
        return self.max_possible_connections_
    ...
    def total_connectivity_between_layers(
        ...
        return round(connections_between_dims / max_possible_connections_between_layers, 2) * 100
    ...
    def dimensions(
        ...
        return self.dimensions[layer_idx]
