...
if __name__ == '__main__':
    ...
    if folder_name == '6_features_nice':
        six_features_list = [
            ...
            f"{folder_name}/2023-09-14-10-22-18_data_for_6_features_good_archs_with_error.pkl"
        ]
    else:
        six_features_list = [
    ...
    with open(
            f'{base_path}/{folder_path}/ergm_results/{num_features}_features/{exp_name}_J{job_num}_P{point}.pkl',
            'wb+') as fp:
        joblib.dump(res, fp)
